      ...
      {isCartOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-full md:w-[420px] bg-gray-50 z-[110] shadow-2xl flex flex-col"
          >
            {/* Header */}
            <div className="bg-white px-6 py-5 flex items-center justify-between border-b border-gray-100 z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">{totalItems} Item{totalItems !== 1 ? 's' : ''}</p>
                </div>
              </div>
              <button onClick={closeCart} className="p-2 hover:bg-gray-100 rounded-full transition group">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6">
              ...
              {totalItems === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center pb-20">
                  <div className="w-32 h-32 bg-white rounded-full flex items-center justify-center mb-6 shadow-soft">
                ...
                <>
                  ...
                  <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-black text-gray-900 text-sm">Blinkit · ~8 min</h4>
                        <p className="text-[11px] text-gray-400 font-bold uppercase tracking-tight">Quick commerce from Blinkit listings</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    {Object.values(cart).map(({ product, quantity }) => {
                      ...
                      return (
                        <div key={product.id} className="flex gap-4 p-4 border-b border-gray-50 last:border-0 hover:bg-gray-50/50 transition">
                          <div className="w-20 h-20 bg-gray-50 rounded-2xl flex items-center justify-center p-2 border border-gray-100 relative shrink-0">
                            <img 
                          ...
                          <div className="flex-1 flex flex-col justify-between py-1">
                            <div>
                              <h4 className="text-[13px] font-black text-gray-800 leading-tight mb-1 line-clamp-2">{product.name}</h4>
                              <p className="text-[11px] font-bold text-gray-400 uppercase tracking-tight">{product.quantity || product.packSize}</p>
                            </div>
                            <div className="flex items-center justify-between mt-2">
                              <div className="flex flex-col">
                                <span className="font-black text-gray-900 text-sm">₹{price * quantity}</span>
                                {quantity > 1 && <span className="text-[9px] font-bold text-gray-400">₹{price} × {quantity}</span>}
                              </div>
                  ...
                  <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 space-y-4">
                    <h3 className="font-black text-sm text-gray-900 uppercase tracking-widest">Bill Summary</h3>
                    ...
                    <div className="pt-4 border-t border-gray-100 flex justify-between items-center">
                      <span className="font-black text-base text-gray-900">Grand Total</span>
                      <span className="font-black text-xl text-gray-900">₹{subtotal + 2}</span>
                    </div>
                  </div>
            ...
            {/* Bottom Checkout Bar */}
            {totalItems > 0 && (
              <div className="bg-white border-t border-gray-100 p-6 pb-8 z-10 shadow-[0_-10px_20px_rgba(0,0,0,0.02)]">
